class CreateEmployees < ActiveRecord::Migration
  ...
  def self.down
    ...
    def self.create_default
     Employee.create :employee_number => 'admin',:joining_date => Date.today,:first_name => 'Falkia',:last_name => 'Administrator',
       :employee_department_id => 1,:employee_grade_id => 1,:employee_position_id => 1,:employee_category_id => 1,:status => true,:nationality_id =>'133', :date_of_birth => Date.today-365
